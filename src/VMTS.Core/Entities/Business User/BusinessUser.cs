...
public class BusinessUser : BaseEntity
{
    ...
    public ICollection<MaintenaceReport?> MechanicMaintenaceReports { get; set; } = new HashSet<MaintenaceReport>();

    public ICollection<MaintenaceRequest?> ManagerMaintenaceRequests { get; set; } = new HashSet<MaintenaceRequest>(); 
}