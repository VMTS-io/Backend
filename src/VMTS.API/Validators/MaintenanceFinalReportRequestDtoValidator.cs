...
public class MaintenanceFinalReportRequestDtoValidator
    : AbstractValidator<MaintenanceFinalReportRequestDto>
{
    public MaintenanceFinalReportRequestDtoValidator()
    {
        RuleFor(x => x.Notes)
            // .NotEmpty()
