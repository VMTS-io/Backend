...
namespace VMTS.Repository.Data.Migrations
{
    ...
    [Migration("20250313001607_Add new relations and entities")]
    partial class Addnewrelationsandentities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VMTS.Core.Entities.Report.FaultReport", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VMTS.Core.Entities.Trip.TripRequest", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VMTS.Core.Entities.Maintenace.MaintenaceRequest", b =>
                {
                    b.HasOne("VMTS.Core.Entities.User_Business.BusinessUser", "ManagerMaintenanceRequest")
                    ...
                    b.Navigation("ManagerMaintenanceRequest");
            ...
            modelBuilder.Entity("VMTS.Core.Entities.Report.FaultReport", b =>
                {
                    ...
                    b.HasOne("VMTS.Core.Entities.Trip.TripRequest", "TripRequest")
            ...
            modelBuilder.Entity("VMTS.Core.Entities.User_Business.BusinessUser", b =>
                {
                    b.OwnsOne("VMTS.Core.Entities.Identity.Address", "Address", b1 =>
                        {
                            b1.Property<string>("BusinessUserId")
                                .HasColumnType("nvarchar(450)");
                            ...
                            b1.HasKey("BusinessUserId");

                            b1.ToTable("BusinessUser");
